...
<head>
    ...
    <title>GLR Reisbureau - Login</title>
</head>
...
<!--            <center><img class="img-fluid rounded-circle" src="../--><?php //echo $profilepic ?><!--"></center>-->
            <h5 id="Groed"></h5><h4 class="card-title mb-4 mt-1"><?php if (isset($_SESSION['name'])){
                echo $_SESSION['name'];
                } else {
                echo "Gebruiker";
                } ?></h4>
            ...
            <a href="../index.php">← Terug naar homepage</a><a class="mx-5" href="register.php">Meld je aan</a>
        </div>
    <!-- Optional JavaScript -->
